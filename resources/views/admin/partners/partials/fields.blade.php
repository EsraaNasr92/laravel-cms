...
<div class="form-group">
    ...
    @if($model->image != null)
        <img height="100" width=100 src="{{ asset('uploads/partners/' . $model->image) }}">
    @else
        <img style="visibility:hidden"  id="prview" src=" {{ asset('uploads/partners/' . $model->image) }} "  width=100 height=100 />     
    @endif
